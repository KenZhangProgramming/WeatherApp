...
public class TestUriMatcher extends AndroidTestCase {
    ...
    private static final Uri TEST_WEATHER_WITH_LOCATION_DIR = WeatherContract.WeatherEntry.buildWeatherLocation(CITY,COUNTRY);
    private static final Uri TEST_WEATHER_WITH_LOCATION_AND_DATE_DIR = WeatherContract.WeatherEntry.buildWeatherLocationWithDate(CITY,COUNTRY,TEST_DATE);
