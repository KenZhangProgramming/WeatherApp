...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        String CITY = "London";
        String COUNTRY = "UK";
        // content://com.example.android.sunshine.app/weather/London/UK
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocation(CITY,COUNTRY));
        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
        assertEquals("Error: the WeatherEntry CONTENT_URI with location should return WeatherEntry.CONTENT_TYPE",
                WeatherEntry.CONTENT_TYPE, type);

        long testDate = 1419120000L; // December 21st, 2014
        // content://com.example.android.sunshine.app/weather/London/UK/20140612
        type = mContext.getContentResolver().getType(
                WeatherEntry.buildWeatherLocationWithDate(CITY, COUNTRY, testDate));
        // vnd.androtestsunshineid.cursor.item/com.example.android.sunshine.app/weather/1419120000
    ...
    public void testUpdateLocation() {
        ...
        updatedValues.put(LocationEntry.COLUMN_LOCATION_SETTING_CITY, "London");
        updatedValues.put(LocationEntry.COLUMN_LOCATION_SETTING_COUNTRY, "UK");

        // Create a cursor with observer to make sure that the content provider is notifying
        // the observers as expected, the cursor is selecting everything in the table
    ...
    // rin your provide.  It relies on insertions with testInsertReadProvider, so insert and
    ...
    public void testInsertReadProvider() {
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocation(TestUtilities.TEST_CITY,TestUtilities.TEST_COUNTRY),
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
                null  // sort order
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationWithStartDate(
                        TestUtilities.TEST_CITY, TestUtilities.TEST_COUNTRY, TestUtilities.TEST_DATE),
                null, // leaving "columns" null just returns all the columns.
                null, // cols for "where" clause
                null, // values for "where" clause
                null  // sort order
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherEntry.buildWeatherLocationWithDate(TestUtilities.TEST_CITY, TestUtilities.TEST_COUNTRY, TestUtilities.TEST_DATE),
                null,
                null,
                null,
                null
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate+= millisecondsInADay ) {
            ...
            weatherValues.put(WeatherEntry.COLUMN_USER_DESC,"Today is nice and I feel good");
